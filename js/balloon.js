...
(function(w){
    ...
    var ITEM = function(x , y , img,stage){
        ...
        this.x = x+(this.sigleX*ITEM_SCALE)/2 ;
        this.y = y+(this.sigleY*ITEM_SCALE) ;
        this.regX= (this.sigleX*ITEM_SCALE)/2;
        this.regY=(this.sigleY*ITEM_SCALE);
    ...
    ITEM.prototype = {
        init:function(img,stage){
            ...
            createjs.Tween.get(this.shape,{loop:true}).to({rotation:-5},1000).to({rotation:0},1000).to({rotation:5},1000).to({rotation:0},1000);
    ...
    w.createBalloon = function(x , y , img, stage){
